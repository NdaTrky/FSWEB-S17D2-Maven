...
@RestController // Controllerden türer, controller da bir component. Yani Annotationlar arasında da bir parent/child ilişkisi bulunur.
...
@PostConstruct // Uygulama ayağa kalkarken yapmasını istediğimiz işlemleri yapar. Map'i İnitialize etmek için yazarız.
    public void init(){
    this.developers = new HashMap<>();
    this.developers.put(1,new Developer(1, "nida", 1000d, Experience.JUNIOR));
}
...
// Annotationları ayırmanın ne gibi bir avantajı var?
// Hangi katmanlarda ne gibi hatalar aldığımızı anlayabilmek için annotationlar çeşitlendirilmiştir.
